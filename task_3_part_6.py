...
allowed_symbols = set(' qwertyuiopasdfghjklzxcvbnm')
while True:
    inp = input('Enter a word or words in lowercase, separated by a space: ')
    if set(inp).issubset(allowed_symbols):
        print(int_func(inp))
    else:
        print('Enter what is required!')
    print()
